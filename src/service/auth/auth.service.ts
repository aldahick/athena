  ...
  isCheckValid(
    ...
    for (const check of checks) {
      ...
      const isAuthorized = roles.some((r) => {
        ...
        const isAttributeAllowed = permission.attributes.includes("*") || (check.attributes !== undefined && permission.attributes.includes(check.attributes));
